    ...
    <DefaultLayout>
      <div className="min-h-screen flex flex-col justify-between">
              ...
              {edit ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Button onPress={() => navigate("/company")} >Manage company</Button>
                  </div>
                </>
              )}
            ...
            <Tab key="event" title="Events">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {data && data.map((post, index) => (
                  <Card key={index} isPressable onPress={() => navigate(`/event/${post.id}`)} className="flex-grow w-full group/card">
                    <div className={"overflow-hidden relative h-96 rounded-md shadow-xl max-w-sm mx-auto flex flex-col justify-between p-4"}>
        ...
        <div className="flex flex-col gap-4 p-4">
          <Button onPress={() => navigate("/profile/edit")} className="bg-purple-600/50 w-full text-white">Create company</Button>
