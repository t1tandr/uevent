...
export default function createCompany() {
  ...
  const {
    ...
    formState: { errors: errorsPromo, isValid: isValidPromo },
  } = useForm({
    defaultValues: {
      promocode: "",
      discount: "",
    ...
    resolver: zodResolver(
      z.object({
        promocode: z
          .string()
          .min(1, "Promocode must be at least 1 character long"),
        discount: z.coerce
          .number()
      ...
      <div className="flex flex-col gap-10 rounded-lg w-full p-10">
        ...
        >
          ...
          <div className="flex flex-col gap-4 md:flex-row w-full">
            ...
            >
              {(format) => (
                <AutocompleteItem key={format.key}>
                  {format.label}
                </AutocompleteItem>
              )}
            </Autocomplete>
            ...
            >
              {(theme) => (
                <AutocompleteItem key={theme.key}>
                  {theme.label}
                </AutocompleteItem>
              )}
            </Autocomplete>
